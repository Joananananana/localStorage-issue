    ...
    .category-list {
      ...
      .category-item-wrapper {
        ...
        .category-item {
          ...
          box-shadow:px2rem(-5) px2rem(-5) px2rem(10) rgba(255,255,255,1),
          px2rem(-5) px2rem(-5) px2rem(20) rgba(255,255,255,0.5),
          inset px2rem(5) px2rem(5) px2rem(10) rgba(255,255,255,0.5),
          px2rem(5) px2rem(5) px2rem(10) rgba(0,0,0,0.15);
          .img-wrapper {
            flex: 0 0 50%;
            width: 50%;
